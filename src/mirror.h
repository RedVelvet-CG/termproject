...
void create_mirror_vertices(std::vector<vertex>& v) {
	//front
	v.push_back({ vec3(0.8f,1.f,1.0f), vec3(0.f,0.f,0.0f), vec2(1.f, 1.f) });
	v.push_back({ vec3(-1.f,-0.8f,1.0f), vec3(0.f,0.f,0.0f), vec2(0.f, 1.f) });
	v.push_back({ vec3(-0.8f,-1.f,1.0f), vec3(0.f,0.f,0.0f), vec2(0.f, 0.f) });
	v.push_back({ vec3(1.f,0.8f,1.0f), vec3(0.f,0.f,0.0f), vec2(1.f, 0.f) });

	//left
	v.push_back({ vec3(-1.f,-0.8f,1.0f), vec3(0.f,0.f,0.0f), vec2(0.f, 0.75f) });
	v.push_back({ vec3(-1.f,-0.8f,-1.0f), vec3(0.f,0.f,0.0f), vec2(0.f, 0.f) });
	v.push_back({ vec3(-0.8f,-1.f,-1.0f), vec3(0.f,0.f,0.0f), vec2(1.f, 0.f) });
	v.push_back({ vec3(-0.8f,-1.f,1.0f), vec3(0.f,0.f,0.0f), vec2(1.f, 0.75f) });

	//right
	v.push_back({ vec3(0.8f,1.f,-1.0f), vec3(0.f,0.f,0.0f), vec2(0.f, 0.f) });
	v.push_back({ vec3(0.8f,1.f,1.0f), vec3(0.f,0.f,0.0f), vec2(0.f, 0.75f) });
	v.push_back({ vec3(1.f,0.8f,1.0f), vec3(0.f,0.f,0.0f), vec2(1.f, 0.75f) });
	v.push_back({ vec3(1.f,0.8f,-1.0f), vec3(0.f,0.f,0.0f), vec2(1.f, 0.f) });
	...
	v.push_back({ vec3(-1.f,-0.8f,-1.0f), vec3(0.f,0.f,0.0f), vec2(0.f, 0.f) });
	v.push_back({ vec3(0.8f,1.f,-1.0f), vec3(0.f,0.f,0.0f), vec2(1.f, 0.f) });
	v.push_back({ vec3(1.f,0.8f,-1.0f), vec3(0.f,0.f,0.0f), vec2(1.f, 1.f) });
	v.push_back({ vec3(-0.8f,-1.f,-1.0f), vec3(0.f,0.f,0.0f), vec2(0.f, 1.f) });

}

inline void create_front_mirror(std::vector<mirror>& mirrors, int plane = 0) {
	mirror w;
	w = { vec3(-80.0f, 80.0f, 100.0f), plane };
...
inline void create_left_mirror(std::vector<mirror>& mirrors, int plane = 1) {
	mirror w;
	w = { vec3(-80.0f, 80.0f, 100.0f), plane };
	mirrors.emplace_back(w);
	w = { vec3(80.0f, -80.0f, 100.0f), plane };
...
inline void create_right_mirror(std::vector<mirror>& mirrors, int plane = 2) {
	mirror w;
	w = { vec3(-80.0f, 80.0f, 100.0f), plane };
	mirrors.emplace_back(w);
	w = { vec3(80.0f, -80.0f, 100.0f), plane };
...
inline void create_top_mirror(std::vector<mirror>& mirrors, int plane = 3) {
	mirror w;
	w = { vec3(-80.0f, 80.0f, 100.0f), plane };
	mirrors.emplace_back(w);
	w = { vec3(80.0f, -80.0f, 100.0f), plane };
...
inline void create_bottom_mirror(std::vector<mirror>& mirrors, int plane = 4) {
	mirror w;
	w = { vec3(-80.0f, 80.0f, 100.0f), plane };
	mirrors.emplace_back(w);
	w = { vec3(80.0f, -80.0f, 100.0f), plane };
...
inline void create_back_mirror(std::vector<mirror>& mirrors, int plane = 5) {
	mirror w;
	w = { vec3(-80.0f, 80.0f, 100.0f), plane };
	mirrors.emplace_back(w);
	w = { vec3(80.0f, -80.0f, 100.0f), plane };
...
inline std::vector<mirror> create_mirror() {
	...
	//front
	create_front_mirror(mirrors);
	//left
	create_left_mirror(mirrors);
	//right
	create_right_mirror(mirrors);
	//top
	create_top_mirror(mirrors);
	//bottom
	create_bottom_mirror(mirrors);
	//back
	create_back_mirror(mirrors);
	return mirrors;
}
