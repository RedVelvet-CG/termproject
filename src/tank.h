...
inline std::vector<tank> create_tank() {
	...
	tank mytank = { vec3(-40.0f, -80.0f, 100.0f), -PI/2, vec4(0.637f,1.0f,0.611f,0.0f) };
	tank enemy1 = { vec3(-80.0f, 80.0f, 100.0f), PI/2, vec4(1.0f,0.0f,0.0f,0.0f) };
	tank enemy2 = { vec3(0.0f, 80.0f, 100.0f), PI/2, vec4(1.0f,0.0f,0.0f,0.0f) };
	tank enemy3 = { vec3(80.0f, 80.0f, 100.0f), PI/2, vec4(1.0f,0.0f,0.0f,0.0f) };
