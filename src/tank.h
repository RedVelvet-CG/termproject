...
inline std::vector<tank> create_tank() {
	...
	tank mytank = {true, vec3(-40.0f, -80.0f, 0.0f), -PI/2, vec4(0.0f,1.0f,0.15f,0.0f) };
	tank enemy1 = {false, vec3(-80.0f, 80.0f, 0.0f), PI/2, vec4(1.0f,0.0f,0.0f,0.0f) };
	tank enemy2 = {false, vec3(0.0f, 80.0f, 0.0f), PI/2, vec4(1.0f,0.0f,0.0f,0.0f) };
	tank enemy3 = {false, vec3(80.0f, 80.0f, 0.0f), PI/2, vec4(1.0f,0.0f,0.0f,0.0f) };
